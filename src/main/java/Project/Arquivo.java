...
public class Arquivo {
    public static List<Vertice> leArquivoVertice(){
        ...
        try{
            ...
            buff = new BufferedReader(new FileReader("C:/Users/Usuario/Desktop/Projeto SD/src/main/Vertice.txt"));
    ...
    public static void salvaVertices(ArrayList<Vertice> listaVertices){
        try {
            String pathSaida = "C:/Users/Usuario/Desktop/Projeto SD/src/main/Vertice.txt";
            FileWriter saida;
    ...
    public static List<Aresta> leArquivoAresta(){
        ...
        try{
            ...
            buff = new BufferedReader(new FileReader("C:/Users/Usuario/Desktop/Projeto SD/src/main/Aresta.txt"));
    ...
    public static void salvaArestas(ArrayList<Aresta> listaArestas){
        try {
            String pathSaida = "C:/Users/Usuario/Desktop/Projeto SD/src/main/Aresta.txt";
            FileWriter saida;
